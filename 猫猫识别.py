...
# 画图
def draw_train_process(iters, costs, accs, label_cost, lable_acc):
    plt.title("cats inference")
...
for pass_id in range(15):
    ...
    for batch_id, data in enumerate(train_reader()):
        ...
        all_train_iter = all_train_iter + 102400
...
# 画损失/准确率图形
draw_train_process(all_train_iters, all_train_costs, all_train_accs, "training cost", "training acc")
